...
try {
  ...
  const client: NekoDriftClient = {
    ...
    react: async (reaction: NekoDriftReaction, options?: { readonly leaseId?: string }) => {
  ...
  hooks["tool.execute.before"]({ tool: "nekodrift_nekodrift_say" }, { args: {} });
