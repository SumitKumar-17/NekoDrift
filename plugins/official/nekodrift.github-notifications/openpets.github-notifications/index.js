...
export const EMPTY_BASELINE = "__nekodrift_empty__";
...
if (typeof globalThis.NekoDriftPlugin !== "undefined") register(globalThis.NekoDriftPlugin);
...
export async function github(ctx, path, etagKey) {
  const headers = { accept: "application/vnd.github+json", "user-agent": "NekoDrift GitHub Notifications" };
